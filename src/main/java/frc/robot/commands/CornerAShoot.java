...
public class CornerAShoot extends SequentialCommandGroup {
    public CornerAShoot(Arm arm, IntakeSubsystem intake, TopShooter top, BottomShooter bottom){
        addCommands(
            new SetArm(arm, 55), //Arm Angle to shoot --prev:51
