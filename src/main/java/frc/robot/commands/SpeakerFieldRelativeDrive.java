...
public class SpeakerFieldRelativeDrive extends Command{
    DriveSubsystem m_drive;
    GenericHID m_controller;
    PIDController m_PID;

    public SpeakerFieldRelativeDrive(DriveSubsystem drive, GenericHID controller, PIDController PID){
        m_drive = drive;
    ...
    public void execute(){
        m_drive.drive(
            ...
            m_PID.calculate(m_drive.vision.LocationToSpeaker()[1], 0)
